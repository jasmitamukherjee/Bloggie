...
{isError && <AlertMessage type="error" message="Some error has occurred, please visit us later!" />}
{isLoading && <AlertMessage type="loading" message="Loading posts, please wait!" />}
                    {/* Post category */}
                    <PostCategory
