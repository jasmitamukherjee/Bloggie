...
return(
    <div>
        {mutation?.isPending ? <AlertMessage type="loading" message="Verification is in progress..."/>
        :
        // mutation?.isError ?
        // <AlertMessage type="error" message="Verification failed,if you think its a bug, just navigate to dashboard!"/>
        //:
        mutation.isSuccess && 
        <div
